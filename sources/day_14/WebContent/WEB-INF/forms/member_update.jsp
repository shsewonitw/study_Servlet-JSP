...
<form action="<%= request.getContextPath() %>/auth/member_update.do" method="post">
	<table>
		...
		<tr>
			...
			%>
			년 : <input type="text" size="4" name="year" value="<%=year%>">
			월 : <input type="text" size="2" name="month" value="<%=month%>">
			일 : <input type="text" size="2" name="day" value="<%=day%>">
			</td>
		</tr>
