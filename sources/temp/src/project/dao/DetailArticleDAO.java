...
public class DetailArticleDAO {
	...
	public DetailArticle selectOne(Connection conn, DetailArticle obj) {
		...
		String sql = "select * from detail_article where article_id = ?";
	...
	public ArrayList<DetailArticle> selectAll(Connection conn, DetailArticle obj) {
	...
	public boolean insert(Connection conn, DetailArticle obj) {
		...
		String sql = "insert article into a values (null,?,?,?,now(),now(),0)";
