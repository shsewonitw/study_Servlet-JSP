...
public class CommentDAO {
	...
	public boolean update(Connection conn, Comment obj) {
		boolean result = false;
		...
		try {
			...
			pstmt.setInt(2, obj.getComment_id());
	...
	public ArrayList<Comment> selectFive(Connection conn, Comment obj) {
		ArrayList<Comment> result = new ArrayList<>();
		String sql = "select * from comment where member_id = ? order by write_time desc limit 5";
