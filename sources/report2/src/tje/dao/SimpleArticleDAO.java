...
public class SimpleArticleDAO {
	...
	public ArrayList<SimpleArticle> selectFive(Connection conn, SimpleArticle obj) {
		ArrayList<SimpleArticle> result = new ArrayList<>();
		String sql = "select * from simplearticle where member_id = ? order by write_time desc limit 5";
